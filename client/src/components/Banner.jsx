  ...
  return (
    ...
    >
      <div className=" text-white">
        ...
        <p className=" mt-2">
          Browse top-quality rental cars at unbeatable rates. Easy booking,
          flexible pickup and return dates.
        </p>
        <p className=" max-w-130">Visit our website now and ride in style!</p>
        <motion.button
